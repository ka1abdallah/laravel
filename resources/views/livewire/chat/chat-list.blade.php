<div>
    ...
    <div class="chatlist_header">
        ...
        <div class="img_container">
            <img src="https://ui-avatars.com/api/?background=0D8ABC&color=fff&name=
            {{auth()->user()->name}}" alt="">
        </div>
    </div>
        ...
        @if (count($conversations) > 0)
            @foreach ($conversations as $conversation)
                <div class="chatlist_item" wire:key='{{$conversation->id}}' 
                    wire:click="$emit('chatUserSelected', 
                    {{$conversation}},{{$this->getChatUserInstance($conversation, $name = 'id') }})">
                    ...
                    <div class="chatlist_info">
                        ...
                        <div class="bottom_row">
                            ...
                            <div class="message_body text-truncate" style="color:#111111;">
